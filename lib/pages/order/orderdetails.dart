...
//   }
  ...
  Future orderConfirm() async {
    try {
      Map<String, dynamic> postData = {
        ...
        "prepare_min": _timingValues[_selectedChipIndex!].toString()
      };
  ...
  final List<String> _timingValues = ["5", "10", "15", "30", "40", "60"];
...
//timer chip
                      ...
                      Wrap(
                        ...
                        children: List.generate(
                          _timingValues.length,
                          (index) => ChoiceChip(
                            // Display numeric values directly
                            label: Text(
                              "${_timingValues[index]} mins", // Use numeric value as label
                              style: TextStyle(
                            ...
                            onSelected: (bool selected) {
                              setState(() {
                                ...
                                if (selected) {
                                  print(
                                      "Selected Minutes: ${_timingValues[index]} mins");
                                }
                              });
                            },
                      ...
                      //   runSpacing: 12,
                      //   children: List.generate(
                      //     _timingOptions.length,
                      //     (index) => ChoiceChip(
                      //       label: Text(_timingOptions[index]),
                      //       selected: _selectedChipIndex == index,
                      //       onSelected: (bool selected) {
                      //         setState(() {
                      //           _selectedChipIndex = selected ? index : null;
                      //           if (selected) {
                      //             print("Selected: ${_timingOptions[index]}");
                      //           }
                      //         });
                      //       },
                      //       selectedColor: Colors.red,
                      //       showCheckmark: false, // Color when selected
                      //       side: BorderSide(
                      //           color: _selectedChipIndex == index
                      //               ? Colors.transparent
                      //               : AppColors.lightGrey7),

...
import '../api_model/payment_delete_model.dart';
...
class _ScreenshotPageState extends State<ScreenshotPage> {
  ...
  //delete
  Future deletepaymentsById(int id) async {
    ...
    if (dialogBoxResult == 'OK') {
      ...
      var result = await apiService.deletepaymentsById(postData);
      DeletePaymentModel response = deletePaymentModelFromJson(result);

      if (response.status.toString() == 'SUCCESS') {
        // showInSnackBar(context, response.message.toString());
        showInSnackBar(context, "Payment list deleted Successfully");
        setState(() {
          getScreenshotpage();
        });
      } else {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isFirstItem = index == 0 ||
                            screenshotpage[index].storeName !=
                                screenshotpage[index - 1].storeName;
                        DateTime createdDate = DateTime.parse(e.createdDate!);

                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if (isFirstItem) // Only show the store information once per store
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 10),
                                    Divider(height: 10, color: AppColors.grey1),
                                    SizedBox(height: 10),
                                    Row(
                                      mainAxisAlignment:
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                if (createdDate.year == DateTime.now().year &&
                                    ...
                                    createdDate.day == DateTime.now().day)
                                  SizedBox(
                                    width: 90,
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          SizedBox(width: 10),
                                          SubHeadingWidget(title: '12455221'),
                                        ],
                                      ),
                                    ),
                                  ),

...
class Editorder extends StatefulWidget {
  ...
  Editorder({super.key, this.invoiceNumber});
...
class _EditorderState extends State<Editorder> {
  ...
  Future admingetAllCartList() async {
    ...
    try {
      var result = await apiService.admingetCartList();
  ...
  Future adminaddQuantity(int productId, int? storeId) async {
    Map<String, dynamic> postData = {
      "store_id": storeId,
      "product_id": productId
    };

    var result = await apiService.adminaddQuantity(postData);
  ...
  Future adminremoveQuantity(int productId, int? storeId) async {
    Map<String, dynamic> postData = {
      "store_id": storeId,
      "product_id": productId
    };

    var result = await apiService.adminremoveQuantity(postData);
    var response = addQuantityModelFromJson(result);
    if (response.status.toString() == 'SUCCESS') {
      // showInSnackBar(context, response.message.toString());
      admingetAllCartList();
  ...
  Future createorder() async {
    ...
    try {
      var result = await apiService.adminupdateorder(postData);
  ...
  Future admindeleteCart(int productId, int? storeId) async {
    ...
    if (dialogBoxResult == 'OK') {
      ...
      var result = await apiService.admindeleteCart(postData);
      var response = addQuantityModelFromJson(result);
      if (response.status.toString() == 'SUCCESS') {
        showInSnackBar(context, response.message.toString());
  ...
  Future admingetalladdressList() async {
    setState(() {
      isLoading = true;
    });

    try {
      var result = await apiService.admingetalladdressListuser();
                                                                        ...
                                                                        GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            setState(() {
                                                                              ...
                                                                              if (item.quantity > 0) {
                                                                                adminremoveQuantity(item.productId, item.storeId);
                                                                              } else {
                                                                                admindeleteCart(item.productId, item.storeId);
                                                                              }
                                                                            });
                                                                          },
                                                                          child:
                                                                        ...
                                                                        GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            setState(() {
                                                                              ...
                                                                              adminaddQuantity(item.productId, item.storeId);
                                                                            });
                                                                          },
                                                                          child:
                                                                              Container(
